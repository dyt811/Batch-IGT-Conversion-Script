...
for subjectNumber = 0:80
    ...
    rowRange = strcat ( ...
        num2str(1 + offSet + subjectNumber*5), ...
        ':', ... 
        num2str(offSet + numberOfConditions+subjectNumber*5) ...
        );
    ...
    %Declare names, onests, durations cell array that WILL BE EXPORTED into
    %the MAT files
    ...
    save(strcat(ConditionName{1,1},'WL'),'names', 'onsets', 'durations');
end